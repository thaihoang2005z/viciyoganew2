...
`;
  ...
  return createPortal(
    ...
    >
      <div className="bg-[#FFFDF8] w-full max-w-2xl rounded-3xl shadow-2xl border border-[#E8DFC8] overflow-hidden max-h-[92vh] sm:max-h-[85vh] my-auto flex flex-col text-[#252822] animate-in zoom-in-95 duration-200">
        {/* Header */}
