...
export default function AdminLoginModal({
  ...
  return createPortal(
    ...
    >
      <div className="bg-[#FFFDF8] w-full max-w-md rounded-3xl shadow-2xl border border-[#E8DFC8] overflow-hidden my-auto animate-in zoom-in-95 duration-200 max-h-[92vh] overflow-y-auto">
